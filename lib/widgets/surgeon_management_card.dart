      ...
      child: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text('Surgeon Management', style: Theme.of(context).textTheme.titleLarge),
              ...
              Text('Surgeon List', style: Theme.of(context).textTheme.titleMedium),
              const Divider(),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () {
                          Provider.of<AppState>(context, listen: false).removeSurgeon(surgeon.id);
                          ScaffoldMessenger.of(context).showSnackBar(
